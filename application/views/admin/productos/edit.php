                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo base_url();?>mantenimiento/productos/update" method="POST">
                            ...
                            <div class="form-group <?php echo !empty(form_error('stock')) ? 'has-error':'';?>">
                                ...
                                <input type="text" class="form-control" id="stock_minimo" name="stock_minimo" value="<?php echo !empty(form_error('stock_minimo')) ? set_value('stock'):$producto->stock_minimo?>">
